...
<main class=" min-vh-75 p-4">
    <div class="container-md">
        ...
        <div style="width:clamp(300px,90vw,700px)" class="me-auto ms-auto" >
            <div class="text-center" > <img src="<?php echo "../public/".$user['FilePath']; ?>" class="rounded-circle " width="150" height="150" alt=""></div>
            <form action="../app/controllers/editusercontroller.php" class="p-4 border rounded mt-4" method="post" enctype="multipart/form-data">
                ...
                <div class="text-end" >
                   <a href="../public/userdata.php" class="" ><button type="button" class="btn btn-warning text-white">Back</button></a>  <input type="submit" name="button" id="button" class="btn btn-primary mt-3 mb-3" value="submit">
                </div>
            </form>
        </div>
    </div>

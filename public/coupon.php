...
<main class="p-5">
    <div class="container">
        <form id="Token" method="post" class="form border me-auto ms-auto p-3" style="width:clamp(300px,90vw,800px)">
            ...
            <input type="number" name="Discount_Value" id="Discount_Value" min="0" placeholder="Enter Value Accoundding to Discount Type" class="form-control my-3" required>
            <label for="usable">Usable</label>
            <input type="number" name="Usable_token" id="Usable_token" placeholder="Enter Value of token usable time" class="form-control my-3" min="1" required>

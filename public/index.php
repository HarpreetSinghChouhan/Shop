        ...
        <div class="row">
            ...
            ?>
                <div class="col-md-6 col-xl-4 mt-3 ">
                    <div class="card p-3">
                       <a href="../public/description.php?id=<?php echo $row['productid'] ?>"> <img src="<?php echo "data:" . $row['ptype_image'] . ";base64," . base64_encode($row['product_image']) ?>" height="350" class="card-img-top"></a>
                        <div class="card-text">
